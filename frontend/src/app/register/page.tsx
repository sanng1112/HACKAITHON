  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({
        ...
        so_cccd: form.so_cccd || undefined,
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-govone-50 to-white p-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8 animate-slide-up">
          <h2 className="text-lg font-semibold text-gray-900 mb-6">Đăng ký</h2>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">
              Đã có tài khoản?{' '}
              <Link href="/login" className="text-govone-600 hover:text-govone-700 font-medium">
                Đăng nhập
              </Link>
            </p>
          </div>
